...
classdef VREP
    ...
    %% Constructor (open the comunication with VREP )
    ...
    methods
        ...
        function obj = VREP(port)
            ...
            [~, obj.cone_handle] = obj.vrep.simxGetObjectHandle(obj.clientID, 'Cone' ,obj.vrep.simx_opmode_blocking);
            [~, obj.target_handle] = obj.vrep.simxGetObjectHandle(obj.clientID, 'Cylinder0' ,obj.vrep.simx_opmode_blocking);
            [~, obj.cylinder_handle] = obj.vrep.simxGetObjectHandle(obj.clientID, 'Cylinder' ,obj.vrep.simx_opmode_blocking);
