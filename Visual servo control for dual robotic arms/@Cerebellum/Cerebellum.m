...
classdef Cerebellum
    ...
    methods
        ...
        function obj = Cerebellum(reservoirSize, learningRate, LINParameter,... 
            ...
            % This make the reservoir to reach the steady state
            % (Not necessary)
            u = zeros(inputDimension,1);
            for i = 1:200
                obj.cell = (1-1/LINParameter*leakyRate)*obj.cell + 1/LINParameter*obj.sigmoid(obj.Win*u+obj.W*obj.cell);
            end
