...
classdef UR
    ...
    methods
        function obj = UR(numberOfSampling, vrepInstance)
            ...
            for i = 1:obj.jointNumber
                [~, obj.joint_handle(i)] = vrepInstance.vrep.simxGetObjectHandle(vrepInstance.clientID, ['UR5_joint',num2str(i)], vrepInstance.vrep.simx_opmode_blocking);
            end
   ...
   %% functions
    methods (Static)
        ...
        ret = InitializeJacobian(obj, initialJointAngle, vrepInstance, index);
